  ...
  <div class="space-y-6">
    ...
    <div>
      ...
      <div class="relative">
        ...
        <input v-model="email" type="text" placeholder="info@gmail.com"
    ...
    <div>
      ...
      <div class="relative">
        ...
        <input v-model="phoneNumber" placeholder="+1 (555) 000-0000" type="tel"
    ...
    <div>
      ...
      <div class="relative">
        ...
        <input v-model="phoneNumber2" placeholder="+1 (555) 000-0000" type="tel"
    ...
    <div>
      ...
      <div class="relative">
        ...
        <input v-model="url" type="url" placeholder="www.tailadmin.com"
