export const LAYOUT_TEMPLATE_OPTIONS = [
	...
	{ label: '3 parçalı triptych (3 dikey panel yan yana)', value: '3-triptych' },
	...
	{ label: '3 parçalı dikey (3 квадрата в столбце)', value: '3-square-vertical' },
	{ label: '4 parçalı kare grid (collage 2×2)', value: '4-grid-square' },
